...
{
    /// <summary>
    /// Menu Event acts as common base class for specialized interface menu event types. The specialized types are associated with different event scopes,
    ...
    {
        protected MenuEventImplementation _eventImp;    // The actual event handler instance.
        ...
        /// <summary>
        /// The constructor creates a new menu event implementation using the contents from the provided configuration section.
        /// </summary>
        ...
        internal MenuEvent (string name, List<string> packages, List<string> stereotypes, List<string> classes)
        {
            this._name = name;
            this._eventImp = null;
        ...
        internal void Bind(MenuEventImplementation imp)
        {
            this._eventImp = imp;
