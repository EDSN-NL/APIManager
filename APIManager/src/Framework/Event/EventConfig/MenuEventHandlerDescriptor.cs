...
{
    /// <summary>
    /// Helper class that represents a single menu event handler definition from configuration....
    /// </summary>
    internal sealed class MenuEventHandlerDescriptor
    {
        ...
        internal MenuEventHandlerDescriptor(XmlNode node, XmlNamespaceManager nsMgr)
        {
            try
            {
            ...
            {
                Logger.WriteError("Framework.EventConfig.MenuEventHandlerDescriptor >> Error parsing config. descriptor: " + exc.ToString());
            }
        }
    }
}
