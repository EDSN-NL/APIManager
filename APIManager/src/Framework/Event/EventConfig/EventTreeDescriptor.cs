...
{
    /// <summary>
    /// Helper class that represents an event tree. May contain other groups or event handlers.
    /// </summary>
    internal sealed class EventTreeDescriptor
    {
        ...
        internal EventTreeDescriptor(XmlNode node, XmlNamespaceManager nsMgr)
        {
            ...
            {
                Logger.WriteError("Framework.EventConfig.EventTreeDescriptor >> Error parsing config. descriptor: " + exc.ToString());
            }
        }
    }
}
