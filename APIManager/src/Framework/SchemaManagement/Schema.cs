...
namespace Framework.Util.SchemaManagement
{
    ...
    internal abstract class Schema
    {
        ...
        internal abstract bool AddABIEType(int nodeID, string className, List<MEDocumentation> annotation, List<SchemaAttribute> attributeList, List<SchemaAssociation> associationList);
