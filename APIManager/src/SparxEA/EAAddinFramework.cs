...
namespace EAAddinFramework
{
    ...
    public abstract class EAAddinBase
    {
        ...
        protected Repository _repository;   // Reference to the repository currently being used.

        /// <summary>
        /// the name of the menu. 
        /// Set this name in the constructor of the derived add-in class
        /// The declaration below creates get- and set methods for the variable.
        /// </summary>
        ...
        /// <summary>
        /// The EA_GetMenuItems event enables the Add-In to provide the Enterprise Architect user interface with additional Add-In menu options in various context and main menus. 
        /// When a user selects an Add-In menu option, an event is raised and passed back to the Add-In that originally defined that menu option.
        ...
        /// <summary>
        /// The EA_GetMenuState event enables the Add-In to set a particular menu option to either enabled or disabled. This is useful when dealing with locked packages and other situations where it is convenient to show a menu 
        ...
        /// This event is made available to provide the Add-In with the opportunity to generally set public Add-In flags to augment the MDG_PreGenerate, MDG_PostGenerate and MDG_PreReverse events.
        /// Note:
        /// File save checking should not be performed with this function, but should be handled by MDG_PreGenerate, MDG_PostGenerate and MDG_PreReverse.
