...
namespace Plugin.Application.Events.API
{
    class AddRESTOperationEvent : EventImplementation
    {
        ...
        /// The default event context checker has verified the Stereotype of the selected class to be aResource.
        /// We have to check whether we have the correct correct archetype...
        /// </summary>
        ...
        internal override void HandleEvent()
        {
            ...
            var newOperationDecl = new RESTOperationDeclaration(myResource);
